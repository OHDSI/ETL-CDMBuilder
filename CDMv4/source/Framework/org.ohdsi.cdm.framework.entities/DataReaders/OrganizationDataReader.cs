...
{
   public class OrganizationDataReader : IDataReader
   {
      private readonly IEnumerator<Organization> enumerator;

      // A custom DataReader is implemented to prevent the need for the HashSet to be transformed to a DataTable for loading by SqlBulkCopy
      public OrganizationDataReader(List<Organization> batch)
      {
