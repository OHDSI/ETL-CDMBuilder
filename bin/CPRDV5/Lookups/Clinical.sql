...
from {sc}.concept c
join {sc}.concept_relationship cr on c.concept_id = cr.concept_id_1 and cr.relationship_id='Maps to'
join {sc}.concept c1 on cr.concept_id_2 = c1.concept_id and (c1.vocabulary_id = 'RxNorm' /*or c1.vocabulary_id = 'Gemscript'*/)
...
--FROM CTE_VOCAB_MAP
--WHERE SOURCE_VOCABULARY_ID='Read' AND (TARGET_VOCABUALRY_ID='RxNorm' OR TARGET_VOCABUALRY_ID='Gemscript')