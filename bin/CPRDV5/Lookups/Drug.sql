...
FROM CTE_VOCAB_MAP
WHERE SOURCE_VOCABULARY_ID in ('Gemscript', 'JNJ_CPRD_GS_RXN') AND (TARGET_VOCABUALRY_ID='Multilex' OR TARGET_VOCABUALRY_ID='RxNorm') 
AND TARGET_DOMAIN_ID='Drug' AND TARGET_INVALID_REASON is NULL