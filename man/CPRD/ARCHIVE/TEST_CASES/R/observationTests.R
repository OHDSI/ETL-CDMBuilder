createObservationTests <- function()
{
  ...
  expect_observation(person_id = patient$person_id, observation_date='2012-01-01', observation_type_concept_id=38000245,
  ...
  expect_observation(person_id = patient$person_id, observation_date='2011-03-01', observation_type_concept_id=38000280,
                     observation_source_value='R100.00', observation_concept_id=44801932,
  ...
  expect_observation(person_id = patient$person_id, observation_date='2010-01-01', observation_type_concept_id=38000280,
                     observation_source_value='R100.00', observation_concept_id=43054928,
                     observation_source_concept_id=45474099, value_as_concept_id=44801932)
  ...
  expect_observation(person_id=patient$person_id, observation_concept_id=3012377, observation_date='2012-01-01',
  ...
  declareTest('test observation record 4 fields', source_pid = patient$patid, cdm_pid = patient$person_id)
  add_patient(patid = patient$patid, gender = 1, yob = 199, mob = 1, accept = 1, crd = '2010-01-01', pracid = patient$pracid)
  add_test(patid = patient$patid, eventdate = '2012-01-01', medcode = 98196, staffid = 1001, enttype = 288,
           data1 = 3, data2 = 3.700,data3 = 1 ,data4 = 8, data5 =3.400, data6 = 5.100,
           data7 =0 ,data8_value = NULL,data8_date = NULL)
  expect_observation(person_id=patient$person_id, observation_concept_id=3050909, observation_date='2012-01-01',
                     observation_type_concept_id=38000278, value_as_string='= 3.700 High',
                     value_as_number=3.7, observation_source_value=288, qualifier_concept_id=45876384,
                     unit_source_value='%')
  ...
  add_patient(patid = patient$patid, gender = 1, yob = 199, mob = 1, accept = 1, crd = '2010-01-01', pracid = patient$pracid)
  add_additional(patid = patient$patid, enttype = 461, adid = 42, data1_date  = '2007-07-08', data3_date  = '2007-01-08',
                 data4_date  = '2007-07-09')
  add_clinical(patid = patient$patid, eventdate = '2010-01-01', adid = 42)
  add_consultation(patid = patient$patid, eventdate = '2010-01-01', staffid = 1001)
  expect_observation(person_id=patient$person_id, observation_date='2010-01-01', observation_source_value='461-1',
  ...
  add_patient(patid = patient$patid, gender = 1, yob = 199, mob = 1, accept = 1, crd = '2010-01-01', pracid = patient$pracid)
  add_additional(patid = patient$patid, enttype = 372, adid = 45, data1_value  = 15.000, data2_value  = 100977.000,
  ...
  add_patient(patid = patient$patid, gender = 1, yob = 199, mob = 1, accept = 1, crd = '2010-01-01', pracid = patient$pracid)
  add_additional(patid = patient$patid, enttype = 372, adid = 45, data1_value  = 500.000, data2_value  = 10302.00,
                 data3_value  = 0.000)
  add_clinical(patid = patient$patid, eventdate = '2010-01-01', adid = 45)
  add_consultation(patid = patient$patid, eventdate = '2010-01-01', staffid = 1001)
