createPersonTests <- function()
{
  ...
  declareTest("invalid: delete because uts 2014-01-01 > lcd 2012-12-01",source_pid = patient$patid, cdm_pid = patient$person_id)
  ...
  add_patient(patid=patient$patid,gender=1, yob=99, mob=1, accept=1, crd='2010-01-01', deathdate=NULL, tod=NULL,
              pracid=patient$pracid)
  expect_no_person(person_id = patient$person_id)
  ...
  add_patient(patid=patient$patid,gender=0, yob=195, mob=1, accept=1, crd='2010-01-01', deathdate=NULL, tod=NULL,
              pracid=patient$pracid)
  expect_person(person_id = patient$person_id, care_site_id = patient$pracid, gender_concept_id = 8551,
