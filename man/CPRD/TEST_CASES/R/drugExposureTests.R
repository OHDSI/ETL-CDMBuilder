createDrugExposureTests <- function()
{
  ...
  # 12) -- immunization with visit
  patient <- createPatient();
  declareTest('valid immunization with visit',source_pid = patient$patid, cdm_pid = patient$person_id)
  add_patient(patid = patient$patid, gender = 1, yob = 199, mob = 1, accept = 1, crd = '2010-01-01', pracid=patient$pracid)
  add_immunisation(patid = patient$patid, eventdate = '2012-01-01', medcode = 72, staffid = 1001, status=1)
  add_consultation(patid = patient$patid, eventdate = '2012-01-01', staffid = 9001)
  expect_drug_exposure(person_id = patient$person_id, drug_concept_id = 523620, drug_source_value = '65F5.00',
  ...
  # 13) -- immunization without visit
  patient <- createPatient();
  declareTest('valid immunization without visit - null visit_occur_id',source_pid = patient$patid, cdm_pid = patient$person_id)
  add_patient(patid = patient$patid, gender = 1, yob = 199, mob = 1, accept = 1, crd = '2010-01-01', pracid=patient$pracid)
  add_immunisation(patid = patient$patid, eventdate = '2012-01-01', medcode = 28, staffid = 1001, status=1)
  expect_drug_exposure(person_id = patient$person_id, drug_concept_id = 529411,
                       drug_type_concept_id = 38000179, drug_exposure_start_date = '2012-01-01',
  ...
  add_patient(patid = patient$patid, gender = 1, yob = 199, mob = 1, accept = 1, crd = '2010-01-01', pracid=patient$pracid)
  add_clinical(patid = patient$patid, eventdate = '2009-03-01', medcode = 58, staffid = 1001)
  expect_no_drug_exposure(person_id = patient$person_id)
  ...
  add_patient(patid = patient$patid, gender = 1, yob = 199, mob = 1, accept = 1, crd = '2010-01-01', pracid=patient$pracid)
  add_clinical(patid = patient$patid, eventdate = '2010-03-01', medcode = 58, staffid = 1001)
  expect_drug_exposure(person_id = patient$person_id, drug_concept_id=19136026, drug_type_concept_id=38000178,
                       drug_source_concept_id=45425498)
  expect_count_drug_exposure(person_id = patient$person_id, rowCount = 1)
  ...
  add_patient(patid = patient$patid, gender = 1, yob = 199, mob = 1, accept = 1, crd = '2010-01-01', pracid=patient$pracid)
  add_referral(patid = patient$patid, eventdate = '2010-03-01', medcode = 58, staffid = 1001)
  expect_drug_exposure(person_id = patient$person_id, drug_concept_id=19136026, drug_type_concept_id=38000178,
                       drug_source_concept_id=45425498)
  expect_count_drug_exposure(person_id = patient$person_id, rowCount = 1)
  ...
  add_patient(patid = patient$patid, gender = 1, yob = 199, mob = 1, accept = 1, crd = '2010-01-01', pracid=patient$pracid)
  add_test(patid = patient$patid, eventdate = '2010-03-01', medcode = 58, staffid = 1001)
  expect_drug_exposure(person_id = patient$person_id, drug_concept_id=19136026, drug_type_concept_id=38000178,
                       drug_source_concept_id=45425498)
  expect_count_drug_exposure(person_id = patient$person_id, rowCount = 1)
  ...
  add_medical(medcode = 25159, read_code = '65B..00')
  ...
  expect_device_exposure(person_id = patient$person_id, device_concept_id=4192787, device_source_value='9b20.00',
  ...
  add_patient(patid = patient$patid, gender = 1, yob = 199, mob = 1, accept = 1, crd = '2010-01-01', pracid=patient$pracid)
  add_clinical(patid = patient$patid, eventdate = '2010-03-01', medcode = 25159, staffid = 1001)
  expect_drug_exposure(person_id = patient$person_id, drug_concept_id=19136026, drug_source_value='65B..00',
  ...
  declareTest('valid entry',source_pid = patient$patid, cdm_pid = patient$person_id)
  add_patient(patid = patient$patid, gender = 1, yob = 199, mob = 1, accept = 1, crd = '2010-01-01', pracid=patient$pracid)
  add_test(patid = patient$patid, eventdate = '2010-03-01', medcode = 25159, staffid = 1001)
  expect_drug_exposure(person_id = patient$person_id, drug_concept_id=19136026, drug_source_value='65B..00',
                       drug_type_concept_id=38000178)
  expect_count_drug_exposure(person_id = patient$person_id, rowCount = 1)
