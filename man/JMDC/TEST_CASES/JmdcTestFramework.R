...
add_enrollment <- function(member_id = "M002629711", year_of_birth_of_member = "1973", gender_of_member = "male", individual_or_family = "Individual", month_and_year_of_entry = "200804", month_and_year_of_withdrawal = NULL, month_and_year_of_contract_start = "200801", month_and_year_of_contract_end = NULL, death_flag = "0") {
  insertFields <- c()
  insertValues <- c()
...
add_institution <- function(institution_id = "F0034058", number_of_beds = "0-19", large_classification_of_department = "Internal Medicine", medium_classification_of_department = "General Internal Medicine") {
  insertFields <- c()
  insertValues <- c()
...
add_claim <- function(claim_id = "C000110366921", member_id = "M001430638", type_of_claim = "out-patient", month_and_year_of_medical_care = "201303", institution_id = "F0034824", large_classification_of_department = NULL, medium_classification_of_department = NULL, actual_number_of_days_of_medical_care = "1", points = "338") {
  insertFields <- c()
  insertValues <- c()
  if (!is.null(claim_id)) {
...
add_physician <- function(physician_id = "P0230240", large_classification_of_department = NULL, medium_classification_of_department = NULL) {
  insertFields <- c()
  insertValues <- c()
...
add_diagnosis <- function(claim_id = "C000053908640", member_id = "M003154708", type_of_claim = "out-patient", month_and_year_of_medical_care = "201303", admission_date = NULL, month_and_year_of_start_of_medical_care = "20110506", institution_id = "F0034824", icd10_level4_code = "J304", icd10_level1_code = "J00-J99", icd10_level1_name = "Diseases of the respiratory system", icd10_level2_code = "J00-J06", icd10_level2_name = "Acute upper respiratory infections", icd10_level3_code = "J30", icd10_level3_name = "Vasomotor and allergic rhinitis", icd10_level4_name = "Allergic rhinitis, unspecified", standard_disease_code = "4779004", standard_disease_name = "allergic rhinitis", suspicion_flag = "0", discharge_date = NULL, outcome = "0") {
  insertFields <- c()
  insertValues <- c()
  if (!is.null(claim_id)) {
    insertFields <- c(insertFields, "[claim id]")
...
add_drug <- function(claim_id = "C000073628338", member_id = "M001390875", type_of_claim = "pharmacy", institution_id = "F0017014", physician_id = NULL, month_and_year_of_medical_care = "201303", date_of_prescription = NULL, duration_per_prescription = "1", administered_amount = "1", drug_code = "100000066676", as_needed_medication_flag = "0", daily_dose_per_prescription = "1", unit_of_administered_amount = "T", atc_level1_code = "R", atc_level1_name = "RESPIRATORY SYSTEM", atc_level2_code = "R05", atc_level2_name = "COUGH AND COLD PREPARATIONS", atc_level3_code = "R05C", atc_level3_name = "EXPECTORANTS", atc_level4_code = "R05C-", atc_level4_name = "EXPECTORANTS", who_atc_code = "R05CB03", who_atc_name = "Carbocisteine", statement_id = "1", general_name = "L-carbocisteine", brand_name = "Mucodyne", drug_name = "Mucodyne DS 50%", standardized_unit = "1g", generic_drug_flag = "0", formulation_large_classification_name = "oral use", formulation_medium_classification_name = "tablet", concurrent_id = "1", category_of_medical_care = "0", standard_price = "5.6000", actual_point = "0", claim_code = "621989901") {
  insertFields <- c()
  insertValues <- c()
  if (!is.null(claim_id)) {
    insertFields <- c(insertFields, "[claim id]")
...
add_procedure <- function(claim_id = "C000077972593", member_id = "M007020051", type_of_claim = "out-patient", month_and_year_of_medical_care = "201303", date_of_procedure = NULL, institution_id = "F0017014", icd9cm_level1 = NULL, statement_id = "1", procedure_medical_care_category_medium_classification_name = "検査", procedure_medical_care_category_small_classification_name = "検体検査料", procedure_medical_care_category_subclassification_name = "再診料", icd9cm_level2 = NULL, icd9cm_level3 = NULL, icd9cm_level4 = NULL, icd9cm_level5 = NULL, procedure_code = "A001", standardized_procedure_id = "112007410", standardized_procedure_name = "再診", number_of_times = "1", concurrent_id = "1", category_of_medical_care = "60", standard_point = "11", actual_point = "0") {
  insertFields <- c()
  insertValues <- c()
  if (!is.null(claim_id)) {
    insertFields <- c(insertFields, "[claim id]")
...
add_health_checkups <- function(member_id = "M000271824", month_and_year_of_health_chechups = "201204", bmi = "22.0", amount_of_visceral_fat = NULL, abdominal_girth = NULL, sbp = "120", dbp = "70", tc = NULL, tg = NULL, hdl_c = NULL, ldl_c = NULL, gpt = NULL, g_gt = NULL, fasting_blood_sugar = NULL, casual_blood_sugar = NULL, hba1c = NULL, urine_sugar = "1", urine_protein = "1", hematocrit = NULL, hemoglobin = NULL, red_blood_cell_count = NULL, serum_uric_acid = NULL, serum_creatinine = NULL, electrocardiogram = NULL, ophthalmoscopy_k_w_classificatio = NULL, ophthalmoscopy_scheie_classifica = NULL, ophthalmoscopy_scheie_classific0 = NULL, ophthalmoscopy_scott_classificat = NULL, smoking_habits = "2", eating_habit_1 = "2", eating_habit_2 = "2", eating_habit_3 = "2", eating_habit_4 = "2", drinking_habits = "3", sleeping = "1") {
  insertFields <- c()
  insertValues <- c()
  if (!is.null(member_id)) {
    insertFields <- c(insertFields, "[member id]")
...
add_material <- function(claim_id = "C000112535600", statement_id = "1", member_id = "M003871013", type_of_claim = "out-patient", month_and_year_of_medical_care = "201205", date_of_procedure = NULL, institution_id = "F0110551", material_category_large_classification_name = "画像診断特定保険医療材料料", material_category_medium_classification_name = "フィルム", material_code = "UN100", standardized_material_id = "739200000", standardized_material_name = "液体酸素・定置式液化酸素貯槽（ＣＥ）", unit = NULL, number_of_material = "1", concurrent_id = NULL, category_of_medical_care = "40", standard_price = "0.0000", actual_point = NULL) {
  insertFields <- c()
  insertValues <- c()
  if (!is.null(claim_id)) {
    insertFields <- c(insertFields, "[claim id]")
...
add__version <- function(version_id = "285", version_date = "2015-09-17") {
  insertFields <- c()
  insertValues <- c()
