createDeathTests <- function()
{
  ...
  add_medical_claims(clmid = claim$clmid, clmseq = '001', diag1 = '7616', lst_dt = '2013-07-01',
  ...
  add_medical_claims(clmid = claim$clmid, clmseq = '001', diag1 = '7616', lst_dt = '2013-07-01',
                     icd_flag = '9', pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-07-01', prov = '111111', provcat = '5678')
  add_medical_claims(clmid = claim$clmid, clmseq = '001', diag1 = '7061', lst_dt = '2013-07-31',
                     icd_flag = '9', pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-07-31', prov = '111111', provcat = '5678')
  expect_death(person_id = patient$person_id)
  ...
  add_medical_claims(clmid = claim$clmid, clmseq = '001', diag1 = '7616', lst_dt = '2013-07-01',
                     icd_flag = '9', pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-07-01', prov = '111111', provcat = '5678')
  add_medical_claims(clmid = claim$clmid, clmseq = '001', diag1 = '7061', lst_dt = '2013-08-02',
                     icd_flag = '9', pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-08-02', prov = '111111', provcat = '5678')
  ...
  add_medical_claims(clmid = claim$clmid, clmseq = '001', diag1 = '7616', lst_dt = '2013-07-01',
                     icd_flag = '9', pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-07-01', prov = '111111', provcat = '5678')
  add_medical_claims(clmid = claim$clmid, clmseq = '001', diag1 = 'V1007', lst_dt = '2013-07-31', proc_cd = '64475',
                     icd_flag = '9', pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-07-31', prov = '111111', provcat = '5678')
  expect_death(person_id = patient$person_id)
  ...
  add_medical_claims(clmid = claim$clmid, clmseq = '001', diag1 = '7616', lst_dt = '2013-07-01',
                     icd_flag = '9', pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-07-01', prov = '111111', provcat = '5678')
  add_medical_claims(clmid = claim$clmid, clmseq = '001', diag1 = 'V1007', lst_dt = '2013-08-02', proc_cd = '64475',
                     icd_flag = '9', pat_planid = patient$patid, patid = patient$patid, fst_dt = '2013-08-02', prov = '111111', provcat = '5678')
  expect_no_death(person_id = patient$person_id)
  ...
  if (tolower(Sys.getenv("extendedType")) == "dod")
  {
    ...
    add_member_detail(aso = 'N', bus = 'COM', cdhp = 3, eligeff = '2010-05-01', eligend = '2013-10-31',
                      gdr_cd = 'F', patid = patient$patid, pat_planid = patient$patid, product = 'HMO', yrdob = 1969)
    add_death(patid = patient$patid, ymdod = '201307', extract_ym = '201606', version = '6.0')
    add_medical_claims(clmid = claim$clmid, clmseq = '001', diag1 = '7616', lst_dt = '2011-08-02', proc_cd = '64475',
                       icd_flag = '9', pat_planid = patient$patid, patid = patient$patid, fst_dt = '2011-08-02', prov = '111111', provcat = '5678')
    expect_death(person_id = patient$person_id, death_date = '2013-07-31')
  }
}
