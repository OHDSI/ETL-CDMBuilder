...
MEASUREMENT_CONCEPT_ID|**LAB_RESULTS**<br>LOINC_CD<br>PROC_CD<br><br>**MED_DIAGNOSIS**<br>DIAG<br/><br/>**MED_PROCEDURE**<br/>PROC<br/><br/>**MEDICAL_CLAIMS**<br/>PROC_CD|**LAB_RESULTS**<br>(First, look for LOINC_CD. If no map exists, then look for PROC_CD)<br>Use [Source to Standard Terminology](code_snippets.md#source-to-standard-terminology) and filter with [Concept Ids from Other Procedure Fields](code_snippets.md#from-other-procedure-fields)<br><br>**MED_DIAGNOSIS** (DIAG):<br>Use [Source to Standard Terminology](code_snippets.md#source-to-standard-terminology) and filter with [Concept Ids from Medical Claims Diagnosis Fields](code_snippets.md#from-medical-claims-diagnosis-fields)<br><br>**MED_PROCEDURE** (PROC), **MEDICAL_CLAIMS** (PROC_CD)<br/>Use [Source to Standard Terminology](code_snippets.md#source-to-standard-terminology) and filter with [Concept Ids from Medical Claims Procedure Fields](code_snippets.md#from-medical-claims-procedure-fields)<br><br>**LAB_RESULTS** (LOINC_CD)<br>Use [Source to Standard Terminology](code_snippets.md#source-to-standard-terminology) and filter with [Concept Ids from Lab Results LOINC_CD](code_snippets.md#from-lab-results-loinc_cd)| 
MEASUREMENT_DATE|**LAB_RESULTS**:<br>FST_DT<br><br>**MEDICAL_CLAIMS**:<br>FST_DT| | 
MEASUREMENT_DATETIME|Set time to 00:00:00<br/><br/>**LAB_RESULTS**<br/>FST_DT<br/><br/>**MEDICAL_CLAIMS**<br>FST_DT| | 
MEASUREMENT_TYPE_CONCEPT_ID| **MED_DIAGNOSIS**<br/>DIAG_POSITION<br/><br/>**MED_PROCEDURE**<br/>PROC_POSITION|**LAB_RESULTS**<br/> Use concept [44818702 (Lab Result)](http://www.ohdsi.org/web/atlas/#/concept/44818702)  for all rows (Lab Result)<br><br>**DIAG**<br/>Use [Concept Type Ids from Medical Claims Diagnosis Fields](code_snippets.md#from-medical-claims-diagnosis-fields-1)<br/><br/>**PROC**, **PROC_CD**<br/>Use [Concept Type Ids from Medical Claims Procedure Fields](code_snippets.md#from-medical-claims-procedure-fields-1)| 
...
VALUE_AS_NUMBER|**LAB_RESULTS**<br>RSLT_NBR|```if rslt_nbr != 0 then rslt_nbr```<br/>```else NULL```<br/><br/> | Measurements from **MEDICAL_CLAIMS** do not have reliable units to map
...
MEASUREMENT_SOURCE_VALUE|**LAB_RESULTS**<br>LOINC_CD<br>PROC_CD<br><br>**MED_DIAGNOSIS**<br>DIAG<br/><br/>**MED_PROCEDURE**<br/>PROC<br/><br/>**MEDICAL_CLAIMS**<br/>PROC_CD|**LAB_RESULTS**<br>The LOINC_CD or PROC_CD as it appears in the **LAB_RESULTS** table and as was selected above (i.e. use the LOINC_CD first if possible).| 
...
VALUE_SOURCE_VALUE|**LAB_RESULTS**:<br>RSLT_TXT<br><br>**MEDICAL_CLAIMS**<br>PROC_CD<br/><br/>**MED_DIAGNOSIS**<br/>DIAG<br/><br/>**MED_PROCEDURE**<br/>PROC|**LAB_RESULTS** (RSLT_TXT)<br/>```if rslt_nbr == 0 then rslt_txt```<br/>```else rslt_nbr```<br/><br/> | 
