createCostTests <- function()
{
  ...
  add_med_procedure(clmid = claim$clmid, proc = '70481', proc_position = "01")
  add_med_procedure(clmid = claim$clmid, proc = '70481', proc_position = "02")
  add_med_procedure(clmid = claim$clmid, proc = '70481', proc_position = "03")
