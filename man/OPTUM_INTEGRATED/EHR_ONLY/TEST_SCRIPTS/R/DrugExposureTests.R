...
createDrugExposureTests <- function () {
  ...
  add_patient(ptid = patient$ptid, first_month_active = '201005', last_month_active = '201212')
  add_prescriptions_written(ptid=patient$ptid, ndc="55111067101", rxdate='2012-01-08', num_refills="0.0")
  ...
  add_patient(ptid = patient$ptid, first_month_active = '201005', last_month_active = '201212')
  add_prescriptions_written(ptid=patient$ptid, ndc="55111067101", rxdate='2012-01-08', strength="20 - 25", strength_unit = "15 MG", dosefreq = "1 time a day", dosage_form = "Capsule Delayed Release")
  ...
  add_patient(ptid = patient$ptid, first_month_active = '201005', last_month_active = '201212')
  add_patient_reported_meds(ptid=patient$ptid, reported_date='2012-01-08')
  expect_count_drug_exposure(rowCount = 1, person_id = patient$person_id)
  ...
  add_patient(ptid = patient$ptid, first_month_active = '201005', last_month_active = '201212')
  add_patient_reported_meds(ptid=patient$ptid, reported_date='2012-01-08')
  add_patient_reported_meds(ptid=patient$ptid, reported_date='2014-01-08')
  expect_count_drug_exposure(rowCount = 1, person_id = patient$person_id)
  ...
  add_patient(ptid = patient$ptid, first_month_active = '201005', last_month_active = '201212')
  add_patient_reported_meds(ptid=patient$ptid, reported_date='2012-01-08', ndc="55111067101")
  ...
  add_patient(ptid = patient$ptid, first_month_active = '201005', last_month_active = '201212')
  add_patient_reported_meds(ptid=patient$ptid, reported_date='2012-01-08', provid="179865")
  ...
  # add_patient(ptid = patient$ptid, first_month_active = '201005', last_month_active = '201212')
  # add_patient_reported_meds(ptid=patient$ptid, reported_date=NULL, ndc="55111067101")
  # expect_count_drug_exposure(rowCount = 0, person_id = patient$person_id)
  ...
  add_patient(ptid = patient$ptid, first_month_active = '201005', last_month_active = '201212')
  add_patient_reported_meds(ptid=patient$ptid, reported_date='2012-01-08', ndc="55111067101", route="Oral")
  expect_drug_exposure(person_id = patient$person_id, route_concept_id=4128794, route_source_value="Oral")
  ...
  add_patient(ptid = patient$ptid, first_month_active = '201005', last_month_active = '201212')
  add_patient_reported_meds(ptid=patient$ptid, reported_date='2012-01-08', ndc="55111067101", quantity_of_dose="6")
