createObservationTests <- function () {
  ...
  add_patient(ptid=patient$ptid, birth_yr = 1950, gender = 'Male',
              first_month_active = '200701', last_month_active = '201001')
  add_observations(ptid=patient$ptid, obs_date = '2009-01-01', obs_time = '1900-01-01 14:30:00')
  ...
  add_patient(ptid=patient$ptid, birth_yr = 1950, gender = 'Male',
              first_month_active = '200701', last_month_active = '201001')
  add_observations(ptid=patient$ptid, obs_date = '2009-01-01', obs_unit = 'KG')
  expect_observation(person_id = patient$person_id, unit_concept_id = 0, unit_source_value = 'KG')
