createMeasurementTests <- function()
{
  ...
  add_lab_results(labclmid = claim$clmid, pat_planid = patient$pat_planid, ptid = patient$ptid, fst_dt = '2013-07-01', loinc_cd = '22962-5', proc_cd = '87517')
  ...
  add_member_detail(aso = 'N', bus = 'COM', cdhp = 3, eligeff = '2010-05-01', eligend = '2013-10-31',
                    ptid = patient$ptid, pat_planid = patient$pat_planid, product = 'HMO')
  add_lab_results(labclmid = claim$clmid, fst_dt = '2013-07-01', pat_planid = patient$pat_planid, ptid = patient$ptid, loinc_cd = '22962-5', rslt_nbr = 1000)
  ...
  add_member_detail(aso = 'N', bus = 'COM', cdhp = 3, eligeff = '2010-05-01', eligend = '2013-10-31',
                    ptid = patient$ptid, pat_planid = patient$pat_planid, product = 'HMO')
  add_lab_results(labclmid = claim$clmid, fst_dt = '2013-07-01', pat_planid = patient$pat_planid, ptid = patient$ptid, loinc_cd = '22962-5', 
  ...
  add_encounter(ptid=patient$ptid, encid = enc$encid, interaction_type='Inpatient', interaction_date='2011-01-01')
  ...
  expect_measurement(person_id=patient$person_id, measurement_concept_id=437671, measurement_date='2011-01-01',
  ...
  add_encounter(ptid=patient$ptid, encid = enc$encid, interaction_type='Inpatient', interaction_date='2011-01-01')
  add_diagnosis(ptid=patient$ptid, encid = enc$encid, diagnosis_status = 'Diagnosis of', diagnosis_cd = '7877',
                diagnosis_cd_type = 'ICD9', diag_date = '2011-01-01', primary_diagnosis=1)
  ...
  add_encounter(ptid=patient$ptid, encid = enc$encid, interaction_type='Inpatient', interaction_date='2011-01-01')
  add_diagnosis(ptid=patient$ptid, encid = enc$encid, diagnosis_status = 'Diagnosis of', diagnosis_cd = '7877',
                diagnosis_cd_type = 'ICD9', diag_date = '2011-01-01', primary_diagnosis=6)
  ...
  expect_measurement(person_id=patient$person_id, measurement_concept_id=4031867, measurement_date='2011-01-01',
  ...
  add_member_detail(ptid = patient$ptid, pat_planid = patient$pat_planid, eligeff = '2010-05-01', eligend = '2013-10-31')
  add_encounter(ptid=patient$ptid, encid = enc$encid, interaction_type='Inpatient', interaction_date='2011-01-01')
  add_labs(ptid=patient$ptid, encid = enc$encid, test_name='O2 saturation.oximetry', test_result='100', result_date='2011-01-01')
  expect_measurement(person_id=patient$person_id,measurement_concept_id=4130729,measurement_date='2011-01-01',
  ...
  add_member_detail(ptid = patient$ptid, pat_planid = patient$pat_planid, eligeff = '2010-05-01', eligend = '2013-10-31')
  add_encounter(ptid=patient$ptid, encid = enc$encid, interaction_type='Inpatient', interaction_date='2011-01-01')
  add_labs(ptid=patient$ptid, encid = enc$encid, test_name='O2 saturation.oximetry', test_result='positive', result_date='2011-01-01')
  expect_measurement(person_id=patient$person_id,measurement_concept_id=4130729,measurement_date='2011-01-01',
                     measurement_source_value='O2 saturation.oximetry', measurement_source_concept_id=0,
  ...
  add_member_detail(ptid = patient$ptid, pat_planid = patient$pat_planid, eligeff = '2010-05-01', eligend = '2013-10-31')
  add_encounter(ptid=patient$ptid, encid = enc$encid, interaction_type='Inpatient', interaction_date='2011-01-01')
  add_nlp_measurement(ptid=patient$ptid, encid = enc$encid, measurement_type='WEIGHT',measurement_date='2011-01-01',
                       measurement_value=100)
  expect_measurement(person_id=patient$person_id,measurement_concept_id=3025315,measurement_date='2011-01-01',
  ...
  add_member_detail(ptid = patient$ptid, pat_planid = patient$pat_planid, eligeff = '2010-05-01', eligend = '2013-10-31')
  add_encounter(ptid=patient$ptid, encid = enc$encid, interaction_type='Inpatient', interaction_date='2011-01-01')
  add_observations(ptid=patient$ptid, encid = enc$encid,obs_type='SBP',obs_date='2011-01-01')
  expect_measurement(person_id=patient$person_id,measurement_concept_id=3004249,measurement_date='2011-01-01',
  ...
  add_member_detail(ptid = patient$ptid, pat_planid = patient$pat_planid, eligeff = '2010-05-01', eligend = '2013-10-31')
  add_encounter(ptid=patient$ptid, encid = enc$encid, interaction_type='Inpatient', interaction_date='2011-01-01')
  add_observations(ptid=patient$ptid, encid = enc$encid,obs_type='Zach',obs_date='2011-01-01')
