createPersonTests <- function () {
  ...
  patient <- createPatient();
  declareTest("Tests 1928 and earlier birth year", source_pid = patient$ptid, cdm_pid = patient$person_id)
  add_patient(ptid=patient$ptid, birth_yr = '1928 and earlier', gender = 'Male',
              first_month_active = '200701', last_month_active = '201001')
  expect_person(person_id = patient$person_id, gender_concept_id = 8507, year_of_birth = 1928)
