...
initFramework <- function() {
  ...
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.admsrc;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.admtype;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.aprdrg;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.chgmstr;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.cptcode;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.disstat;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.hospchg;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.icdcode;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.icdpoa;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.msdrg;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.msdrgmdc;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.pat;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.patbill;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.patcpt;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.paticd_diag;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.paticd_proc;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.pattype;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.payor;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.physpec;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.poorigin;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.providers;")
  insertSql <- c(insertSql, "TRUNCATE TABLE @source_schema.readmit;")
  ...
  defaults <- new.env(parent = emptyenv())
  frameworkContext$defaultValues$admsrc = defaults;

  defaults <- new.env(parent = emptyenv())
  frameworkContext$defaultValues$admtype = defaults;

  defaults <- new.env(parent = emptyenv())
  frameworkContext$defaultValues$aprdrg = defaults;
  ...
  frameworkContext$defaultValues$chgmstr = defaults;

  defaults <- new.env(parent = emptyenv())
  defaults$cpt_desc <- "RADIATION TREATMENT DELIVERY"
  frameworkContext$defaultValues$cptcode = defaults;

  defaults <- new.env(parent = emptyenv())
  frameworkContext$defaultValues$disstat = defaults;

  defaults <- new.env(parent = emptyenv())
  defaults$hosp_chg_desc <- "OTHER"
  frameworkContext$defaultValues$hospchg = defaults;

  defaults <- new.env(parent = emptyenv())
  defaults$icd_version <- "10"
  defaults$icd_desc <- "ADMIN,PHYSIOL SYSTS & ANATOM REGS,INT..*"
  defaults$icd_grp <- "14"
  defaults$icd_grp_desc <- "OPERATIONS-MUSCULOSKELETAL SYS"
  defaults$icd_maj_cat <- "31"
  defaults$icd_maj_cat_desc <- "PROCEDURE CODES"
  defaults$icd_diag_proc <- "P"
  defaults$icd_diag_proc_desc <- "Procedure"
  frameworkContext$defaultValues$icdcode = defaults;

  defaults <- new.env(parent = emptyenv())
  frameworkContext$defaultValues$icdpoa = defaults;

  defaults <- new.env(parent = emptyenv())
  frameworkContext$defaultValues$msdrg = defaults;

  defaults <- new.env(parent = emptyenv())
  frameworkContext$defaultValues$msdrgmdc = defaults;

  defaults <- new.env(parent = emptyenv())
  defaults$adm_mon <- "2012410"
  defaults$adm_date <- "2012-10-01"
  defaults$disc_mon <- "2012410"
  defaults$disc_date <- "2012-10-01"
  defaults$prov_id <- "242"
  defaults$i_o_ind <- "O"
  defaults$pat_type <- "30"
  defaults$apr_sev <- "0"
  defaults$apr_mort <- "0"
  defaults$adm_source <- "1"
  ...
  defaults$gender <- "F"
  defaults$race <- "W"
  defaults$admphy_spec <- "4073"
  defaults$adm_phy <- "1121736"
  defaults$attphy_spec <- "4028"
  defaults$att_phy <- "2049218"
  defaults$std_payor <- "360"
  defaults$los <- "0"
  defaults$proj_wgt <- "0.000000"
  defaults$pat_charges <- "94.00"
  defaults$pat_cost <- "0.00"
  defaults$pat_fix_cost <- "0.00"
  defaults$pat_var_cost <- "0.00"
  defaults$disc_mon_seq <- "1"
  defaults$period <- "2012-10-01"
  defaults$apr_drg <- "0"
  defaults$ms_drg <- "0"
  defaults$ms_drg_mdc <- "0000"
  defaults$hispanic_ind <- "U"
  frameworkContext$defaultValues$pat = defaults;

  defaults <- new.env(parent = emptyenv())
  defaults$std_chg_code <- "300305850250000"
  defaults$hosp_chg_id <- "207868464"
  defaults$serv_day <- "1"
  ...
  defaults$period <- "2012-10-01"
  frameworkContext$defaultValues$patbill = defaults;

  defaults <- new.env(parent = emptyenv())
  defaults$pat_key <- "624305963"
  defaults$cpt_code <- "36415"
  defaults$period <- "2015-04-01"
  frameworkContext$defaultValues$patcpt = defaults;

  defaults <- new.env(parent = emptyenv())
  defaults$icd_version <- "9"
  defaults$icd_source <- "0"
  defaults$icd_code <- "401.9"
  defaults$icd_pri_sec <- "S"
  defaults$icd_poa <- "9"
  defaults$period <- "2013-04-01"
  frameworkContext$defaultValues$paticd_diag = defaults;
  ...
  defaults$period <- "2012-10-01"
  frameworkContext$defaultValues$paticd_proc = defaults;

  defaults <- new.env(parent = emptyenv())
  frameworkContext$defaultValues$pattype = defaults;

  defaults <- new.env(parent = emptyenv())
  frameworkContext$defaultValues$payor = defaults;

  defaults <- new.env(parent = emptyenv())
  defaults$phy_spec_desc <- "OTHER SPECIALTY (OS)"
  frameworkContext$defaultValues$physpec = defaults;

  defaults <- new.env(parent = emptyenv())
  frameworkContext$defaultValues$poorigin = defaults;
  ...
  frameworkContext$defaultValues$providers = defaults;

  defaults <- new.env(parent = emptyenv())
  defaults$medrec_key <- "1638950495"
  defaults$i_o_ind <- "I"
  defaults$in_extract <- "1"
  defaults$disc_mon <- "2012308"
  defaults$disc_mon_seq <- "1"
  defaults$calc_los <- "3"
  defaults$gender <- "F"
  defaults$race <- "W"
  defaults$pat_type <- "08"
  defaults$point_of_origin <- "1"
  defaults$disc_status <- "1"
  defaults$adm_type <- "1"
  defaults$ms_drg <- "795"
  defaults$age <- "0"
  defaults$icd_version <- "9"
  defaults$prim_icd_diag_code <- "V30.00"
  defaults$pat_cost <- "0.00"
  defaults$pat_charges <- "0.00"
  frameworkContext$defaultValues$readmit = defaults;
}
...
set_defaults_admsrc <- function(adm_source, adm_src_desc) {
  defaults <- frameworkContext$defaultValues$admsrc;
  if (!missing(adm_source)) {
    defaults$adm_source <- adm_source
  }
  if (!missing(adm_src_desc)) {
    defaults$adm_src_desc <- adm_src_desc
  }
  invisible(defaults)
}

set_defaults_admtype <- function(adm_type, adm_type_desc) {
  defaults <- frameworkContext$defaultValues$admtype;
  if (!missing(adm_type)) {
...
set_defaults_aprdrg <- function(apr_drg, apr_drg_desc) {
  defaults <- frameworkContext$defaultValues$aprdrg;
  if (!missing(apr_drg)) {
...
set_defaults_chgmstr <- function(std_chg_code, std_chg_desc, clin_dtl_code, clin_dtl_desc, clin_sum_code, clin_sum_desc, std_dept_code, std_dept_desc, sum_dept_desc, prod_cat_code, prod_cat_desc, prod_class_code, prod_class_desc, prod_name_code, prod_name_desc, prod_name_meth_code, prod_name_meth_desc) {
  defaults <- frameworkContext$defaultValues$chgmstr;
...
set_defaults_cptcode <- function(cpt_code, cpt_desc) {
  defaults <- frameworkContext$defaultValues$cptcode;
  if (!missing(cpt_code)) {
...
set_defaults_disstat <- function(disc_status, disc_status_desc) {
  defaults <- frameworkContext$defaultValues$disstat;
...
set_defaults_hospchg <- function(hosp_chg_id, hosp_chg_desc) {
  defaults <- frameworkContext$defaultValues$hospchg;
...
set_defaults_icdcode <- function(icd_version, icd_code, icd_desc, icd_grp, icd_grp_desc, icd_maj_cat, icd_maj_cat_desc, icd_diag_proc, icd_diag_proc_desc) {
  defaults <- frameworkContext$defaultValues$icdcode;
  ...
  if (!missing(icd_grp)) {
    defaults$icd_grp <- icd_grp
  }
  if (!missing(icd_grp_desc)) {
    defaults$icd_grp_desc <- icd_grp_desc
  }
  if (!missing(icd_maj_cat)) {
    defaults$icd_maj_cat <- icd_maj_cat
  }
  if (!missing(icd_maj_cat_desc)) {
    defaults$icd_maj_cat_desc <- icd_maj_cat_desc
  }
...
set_defaults_icdpoa <- function(icd_poa, icd_poa_desc, icd_poa_sum_desc) {
  defaults <- frameworkContext$defaultValues$icdpoa;
  if (!missing(icd_poa)) {
...
set_defaults_msdrg <- function(ms_drg, ms_drg_desc) {
  defaults <- frameworkContext$defaultValues$msdrg;
  if (!missing(ms_drg)) {
...
set_defaults_msdrgmdc <- function(ms_drg_mdc, ms_drg_mdc_desc) {
  defaults <- frameworkContext$defaultValues$msdrgmdc;
...
set_defaults_pat <- function(pat_key, adm_mon, adm_date, disc_mon, disc_date, prov_id, i_o_ind, pat_type, apr_sev, apr_mort, adm_source, point_of_origin, adm_type, disc_status, mart_status, age, gender, race, admphy_spec, adm_phy, attphy_spec, att_phy, std_payor, los, proj_wgt, pat_charges, pat_cost, pat_fix_cost, pat_var_cost, disc_mon_seq, period, medrec_key, apr_drg, ms_drg, ms_drg_mdc, hispanic_ind) {
  defaults <- frameworkContext$defaultValues$pat;
  if (!missing(pat_key)) {
    defaults$pat_key <- pat_key
  }
  if (!missing(adm_mon)) {
    defaults$adm_mon <- adm_mon
  }
  if (!missing(adm_date)) {
  ...
  if (!missing(disc_mon_seq)) {
    defaults$disc_mon_seq <- disc_mon_seq
  }
  if (!missing(period)) {
...
set_defaults_patbill <- function(pat_key, std_chg_code, hosp_chg_id, serv_day, std_qty, hosp_qty, bill_charges, bill_cost, bill_fix_cost, bill_var_cost, period) {
  defaults <- frameworkContext$defaultValues$patbill;
  if (!missing(pat_key)) {
    defaults$pat_key <- pat_key
  }
  if (!missing(std_chg_code)) {
...
set_defaults_patcpt <- function(pat_key, cpt_code, period) {
  defaults <- frameworkContext$defaultValues$patcpt;
  if (!missing(pat_key)) {
    defaults$pat_key <- pat_key
  }
  if (!missing(cpt_code)) {
...
set_defaults_paticd_diag <- function(pat_key, icd_version, icd_source, icd_code, icd_pri_sec, icd_poa, period) {
  defaults <- frameworkContext$defaultValues$paticd_diag;
  if (!missing(pat_key)) {
    defaults$pat_key <- pat_key
  }
  if (!missing(icd_version)) {
  ...
  if (!missing(icd_source)) {
    defaults$icd_source <- icd_source
  }
  if (!missing(icd_code)) {
    defaults$icd_code <- icd_code
  }
...
set_defaults_paticd_proc <- function(pat_key, icd_version, icd_source, icd_code, icd_pri_sec, proc_day, proc_phy, procphy_spec, period) {
  defaults <- frameworkContext$defaultValues$paticd_proc;
  if (!missing(pat_key)) {
    defaults$pat_key <- pat_key
  }
  if (!missing(icd_version)) {
...
set_defaults_pattype <- function(pat_type, pat_type_desc) {
  defaults <- frameworkContext$defaultValues$pattype;
  if (!missing(pat_type)) {
    defaults$pat_type <- pat_type
  }
...
set_defaults_payor <- function(std_payor, std_payor_desc) {
  defaults <- frameworkContext$defaultValues$payor;
  if (!missing(std_payor)) {
    defaults$std_payor <- std_payor
  }
...
set_defaults_physpec <- function(phy_spec, phy_spec_desc) {
  defaults <- frameworkContext$defaultValues$physpec;
  if (!missing(phy_spec)) {
...
set_defaults_poorigin <- function(point_of_origin, point_of_origin_desc) {
  defaults <- frameworkContext$defaultValues$poorigin;
  if (!missing(point_of_origin)) {
    defaults$point_of_origin <- point_of_origin
  }
...
set_defaults_providers <- function(prov_id, urban_rural, teaching, beds_grp, prov_region, prov_division, cost_type) {
  defaults <- frameworkContext$defaultValues$providers;
  if (!missing(prov_id)) {
    defaults$prov_id <- prov_id
  }
...
set_defaults_readmit <- function(medrec_key, pat_key, i_o_ind, in_extract, disc_mon, disc_mon_seq, days_from_prior, calc_los, gender, race, pat_type, point_of_origin, disc_status, adm_type, ms_drg, age, icd_version, prim_icd_diag_code, prim_icd_proc_code, pat_cost, pat_charges) {
  defaults <- frameworkContext$defaultValues$readmit;
  if (!missing(medrec_key)) {
    defaults$medrec_key <- medrec_key
  }
  if (!missing(pat_key)) {
  ...
  if (!missing(in_extract)) {
    defaults$in_extract <- in_extract
  }
  if (!missing(disc_mon)) {
    defaults$disc_mon <- disc_mon
  }
  ...
  if (!missing(days_from_prior)) {
    defaults$days_from_prior <- days_from_prior
  }
  if (!missing(calc_los)) {
    defaults$calc_los <- calc_los
  }
  if (!missing(gender)) {
    defaults$gender <- gender
  }
  ...
  if (!missing(prim_icd_diag_code)) {
    defaults$prim_icd_diag_code <- prim_icd_diag_code
  }
  if (!missing(prim_icd_proc_code)) {
    defaults$prim_icd_proc_code <- prim_icd_proc_code
  }
  if (!missing(pat_cost)) {
    defaults$pat_cost <- pat_cost
  }
...
add_admsrc <- function(adm_source, adm_src_desc) {
  defaults <- frameworkContext$defaultValues$admsrc;
  insertFields <- c()
  insertValues <- c()
  if (missing(adm_source)) {
    adm_source <- defaults$adm_source
  }
  if (!is.null(adm_source)) {
    insertFields <- c(insertFields, "adm_source")
    insertValues <- c(insertValues, adm_source)
  }

  if (missing(adm_src_desc)) {
    adm_src_desc <- defaults$adm_src_desc
  }
  if (!is.null(adm_src_desc)) {
    insertFields <- c(insertFields, "adm_src_desc")
    insertValues <- c(insertValues, adm_src_desc)
  }

  statement <- paste0("INSERT INTO @source_schema.admsrc (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
add_admtype <- function(adm_type, adm_type_desc) {
  ...
  if (!is.null(adm_type)) {
    insertFields <- c(insertFields, "adm_type")
    insertValues <- c(insertValues, adm_type)
  }

  if (missing(adm_type_desc)) {
    adm_type_desc <- defaults$adm_type_desc
  }
  if (!is.null(adm_type_desc)) {
    insertFields <- c(insertFields, "adm_type_desc")
    insertValues <- c(insertValues, adm_type_desc)
  }

  statement <- paste0("INSERT INTO @source_schema.admtype (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
add_aprdrg <- function(apr_drg, apr_drg_desc) {
  ...
  if (!is.null(apr_drg)) {
    insertFields <- c(insertFields, "apr_drg")
    insertValues <- c(insertValues, apr_drg)
  }

  if (missing(apr_drg_desc)) {
    apr_drg_desc <- defaults$apr_drg_desc
  }
  if (!is.null(apr_drg_desc)) {
    insertFields <- c(insertFields, "apr_drg_desc")
    insertValues <- c(insertValues, apr_drg_desc)
  }

  statement <- paste0("INSERT INTO @source_schema.aprdrg (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
add_chgmstr <- function(std_chg_code, std_chg_desc, clin_dtl_code, clin_dtl_desc, clin_sum_code, clin_sum_desc, std_dept_code, std_dept_desc, sum_dept_desc, prod_cat_code, prod_cat_desc, prod_class_code, prod_class_desc, prod_name_code, prod_name_desc, prod_name_meth_code, prod_name_meth_desc) {
  ...
  if (!is.null(std_chg_code)) {
    insertFields <- c(insertFields, "std_chg_code")
    insertValues <- c(insertValues, std_chg_code)
  }

  if (missing(std_chg_desc)) {
    std_chg_desc <- defaults$std_chg_desc
  }
  if (!is.null(std_chg_desc)) {
    insertFields <- c(insertFields, "std_chg_desc")
    insertValues <- c(insertValues, std_chg_desc)
  }

  if (missing(clin_dtl_code)) {
    clin_dtl_code <- defaults$clin_dtl_code
  }
  if (!is.null(clin_dtl_code)) {
    insertFields <- c(insertFields, "clin_dtl_code")
    insertValues <- c(insertValues, clin_dtl_code)
  }

  if (missing(clin_dtl_desc)) {
    clin_dtl_desc <- defaults$clin_dtl_desc
  }
  if (!is.null(clin_dtl_desc)) {
    insertFields <- c(insertFields, "clin_dtl_desc")
    insertValues <- c(insertValues, clin_dtl_desc)
  }

  if (missing(clin_sum_code)) {
    clin_sum_code <- defaults$clin_sum_code
  }
  if (!is.null(clin_sum_code)) {
    insertFields <- c(insertFields, "clin_sum_code")
    insertValues <- c(insertValues, clin_sum_code)
  }

  if (missing(clin_sum_desc)) {
    clin_sum_desc <- defaults$clin_sum_desc
  }
  if (!is.null(clin_sum_desc)) {
    insertFields <- c(insertFields, "clin_sum_desc")
    insertValues <- c(insertValues, clin_sum_desc)
  }

  if (missing(std_dept_code)) {
    std_dept_code <- defaults$std_dept_code
  }
  if (!is.null(std_dept_code)) {
    insertFields <- c(insertFields, "std_dept_code")
    insertValues <- c(insertValues, std_dept_code)
  }

  if (missing(std_dept_desc)) {
    std_dept_desc <- defaults$std_dept_desc
  }
  if (!is.null(std_dept_desc)) {
    insertFields <- c(insertFields, "std_dept_desc")
    insertValues <- c(insertValues, std_dept_desc)
  }

  if (missing(sum_dept_desc)) {
    sum_dept_desc <- defaults$sum_dept_desc
  }
  if (!is.null(sum_dept_desc)) {
    insertFields <- c(insertFields, "sum_dept_desc")
    insertValues <- c(insertValues, sum_dept_desc)
  }

  if (missing(prod_cat_code)) {
    prod_cat_code <- defaults$prod_cat_code
  }
  if (!is.null(prod_cat_code)) {
    insertFields <- c(insertFields, "prod_cat_code")
    insertValues <- c(insertValues, prod_cat_code)
  }

  if (missing(prod_cat_desc)) {
    prod_cat_desc <- defaults$prod_cat_desc
  }
  if (!is.null(prod_cat_desc)) {
    insertFields <- c(insertFields, "prod_cat_desc")
    insertValues <- c(insertValues, prod_cat_desc)
  }

  if (missing(prod_class_code)) {
    prod_class_code <- defaults$prod_class_code
  }
  if (!is.null(prod_class_code)) {
    insertFields <- c(insertFields, "prod_class_code")
    insertValues <- c(insertValues, prod_class_code)
  }

  if (missing(prod_class_desc)) {
    prod_class_desc <- defaults$prod_class_desc
  }
  if (!is.null(prod_class_desc)) {
    insertFields <- c(insertFields, "prod_class_desc")
    insertValues <- c(insertValues, prod_class_desc)
  }

  if (missing(prod_name_code)) {
    prod_name_code <- defaults$prod_name_code
  }
  if (!is.null(prod_name_code)) {
    insertFields <- c(insertFields, "prod_name_code")
    insertValues <- c(insertValues, prod_name_code)
  }

  if (missing(prod_name_desc)) {
    prod_name_desc <- defaults$prod_name_desc
  }
  if (!is.null(prod_name_desc)) {
    insertFields <- c(insertFields, "prod_name_desc")
    insertValues <- c(insertValues, prod_name_desc)
  }

  if (missing(prod_name_meth_code)) {
    prod_name_meth_code <- defaults$prod_name_meth_code
  }
  if (!is.null(prod_name_meth_code)) {
    insertFields <- c(insertFields, "prod_name_meth_code")
    insertValues <- c(insertValues, prod_name_meth_code)
  }

  if (missing(prod_name_meth_desc)) {
    prod_name_meth_desc <- defaults$prod_name_meth_desc
  }
  if (!is.null(prod_name_meth_desc)) {
    insertFields <- c(insertFields, "prod_name_meth_desc")
    insertValues <- c(insertValues, prod_name_meth_desc)
  }

  statement <- paste0("INSERT INTO @source_schema.chgmstr (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
add_cptcode <- function(cpt_code, cpt_desc) {
  ...
  statement <- paste0("INSERT INTO @source_schema.cptcode (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
add_disstat <- function(disc_status, disc_status_desc) {
  ...
  if (!is.null(disc_status)) {
    insertFields <- c(insertFields, "disc_status")
    insertValues <- c(insertValues, disc_status)
  }

  if (missing(disc_status_desc)) {
    disc_status_desc <- defaults$disc_status_desc
  }
  if (!is.null(disc_status_desc)) {
    insertFields <- c(insertFields, "disc_status_desc")
    insertValues <- c(insertValues, disc_status_desc)
  }

  statement <- paste0("INSERT INTO @source_schema.disstat (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
add_hospchg <- function(hosp_chg_id, hosp_chg_desc) {
  ...
  if (!is.null(hosp_chg_id)) {
    insertFields <- c(insertFields, "hosp_chg_id")
    insertValues <- c(insertValues, hosp_chg_id)
  }

  if (missing(hosp_chg_desc)) {
    hosp_chg_desc <- defaults$hosp_chg_desc
  }
  if (!is.null(hosp_chg_desc)) {
    insertFields <- c(insertFields, "hosp_chg_desc")
    insertValues <- c(insertValues, hosp_chg_desc)
  }

  statement <- paste0("INSERT INTO @source_schema.hospchg (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}

add_icdcode <- function(icd_version, icd_code, icd_desc, icd_grp, icd_grp_desc, icd_maj_cat, icd_maj_cat_desc, icd_diag_proc, icd_diag_proc_desc) {
  defaults <- frameworkContext$defaultValues$icdcode;
  insertFields <- c()
  insertValues <- c()
  if (missing(icd_version)) {
  ...
  if (!is.null(icd_version)) {
    insertFields <- c(insertFields, "icd_version")
    insertValues <- c(insertValues, icd_version)
  }
  ...
  if (!is.null(icd_desc)) {
    insertFields <- c(insertFields, "icd_desc")
    insertValues <- c(insertValues, icd_desc)
  }

  if (missing(icd_grp)) {
    icd_grp <- defaults$icd_grp
  }
  if (!is.null(icd_grp)) {
    insertFields <- c(insertFields, "icd_grp")
    insertValues <- c(insertValues, icd_grp)
  }

  if (missing(icd_grp_desc)) {
    icd_grp_desc <- defaults$icd_grp_desc
  }
  if (!is.null(icd_grp_desc)) {
    insertFields <- c(insertFields, "icd_grp_desc")
    insertValues <- c(insertValues, icd_grp_desc)
  }

  if (missing(icd_maj_cat)) {
    icd_maj_cat <- defaults$icd_maj_cat
  }
  if (!is.null(icd_maj_cat)) {
    insertFields <- c(insertFields, "icd_maj_cat")
    insertValues <- c(insertValues, icd_maj_cat)
  }

  if (missing(icd_maj_cat_desc)) {
    icd_maj_cat_desc <- defaults$icd_maj_cat_desc
  }
  if (!is.null(icd_maj_cat_desc)) {
    insertFields <- c(insertFields, "icd_maj_cat_desc")
    insertValues <- c(insertValues, icd_maj_cat_desc)
  }

  if (missing(icd_diag_proc)) {
    icd_diag_proc <- defaults$icd_diag_proc
  }
  if (!is.null(icd_diag_proc)) {
    insertFields <- c(insertFields, "icd_diag_proc")
    insertValues <- c(insertValues, icd_diag_proc)
  }

  if (missing(icd_diag_proc_desc)) {
    icd_diag_proc_desc <- defaults$icd_diag_proc_desc
  }
  if (!is.null(icd_diag_proc_desc)) {
    insertFields <- c(insertFields, "icd_diag_proc_desc")
    insertValues <- c(insertValues, icd_diag_proc_desc)
  }

  statement <- paste0("INSERT INTO @source_schema.icdcode (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
add_icdpoa <- function(icd_poa, icd_poa_desc, icd_poa_sum_desc) {
  ...
  if (!is.null(icd_poa)) {
    insertFields <- c(insertFields, "icd_poa")
    insertValues <- c(insertValues, icd_poa)
  }

  if (missing(icd_poa_desc)) {
    icd_poa_desc <- defaults$icd_poa_desc
  }
  if (!is.null(icd_poa_desc)) {
    insertFields <- c(insertFields, "icd_poa_desc")
    insertValues <- c(insertValues, icd_poa_desc)
  }

  if (missing(icd_poa_sum_desc)) {
    icd_poa_sum_desc <- defaults$icd_poa_sum_desc
  }
  if (!is.null(icd_poa_sum_desc)) {
    insertFields <- c(insertFields, "icd_poa_sum_desc")
    insertValues <- c(insertValues, icd_poa_sum_desc)
  }

  statement <- paste0("INSERT INTO @source_schema.icdpoa (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
add_msdrg <- function(ms_drg, ms_drg_desc) {
  ...
  if (!is.null(ms_drg)) {
    insertFields <- c(insertFields, "ms_drg")
    insertValues <- c(insertValues, ms_drg)
  }

  if (missing(ms_drg_desc)) {
    ms_drg_desc <- defaults$ms_drg_desc
  }
  if (!is.null(ms_drg_desc)) {
    insertFields <- c(insertFields, "ms_drg_desc")
    insertValues <- c(insertValues, ms_drg_desc)
  }

  statement <- paste0("INSERT INTO @source_schema.msdrg (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
add_msdrgmdc <- function(ms_drg_mdc, ms_drg_mdc_desc) {
  ...
  if (!is.null(ms_drg_mdc)) {
    insertFields <- c(insertFields, "ms_drg_mdc")
    insertValues <- c(insertValues, ms_drg_mdc)
  }

  if (missing(ms_drg_mdc_desc)) {
    ms_drg_mdc_desc <- defaults$ms_drg_mdc_desc
  }
  if (!is.null(ms_drg_mdc_desc)) {
    insertFields <- c(insertFields, "ms_drg_mdc_desc")
    insertValues <- c(insertValues, ms_drg_mdc_desc)
  }

  statement <- paste0("INSERT INTO @source_schema.msdrgmdc (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}

add_pat <- function(pat_key, adm_mon, adm_date, disc_mon, disc_date, prov_id, i_o_ind, pat_type, apr_sev, apr_mort, adm_source, point_of_origin, adm_type, disc_status, mart_status, age, gender, race, admphy_spec, adm_phy, attphy_spec, att_phy, std_payor, los, proj_wgt, pat_charges, pat_cost, pat_fix_cost, pat_var_cost, disc_mon_seq, period, medrec_key, apr_drg, ms_drg, ms_drg_mdc, hispanic_ind) {
  defaults <- frameworkContext$defaultValues$pat;
  insertFields <- c()
  insertValues <- c()
  if (missing(pat_key)) {
  ...
  if (!is.null(pat_key)) {
    insertFields <- c(insertFields, "pat_key")
    insertValues <- c(insertValues, pat_key)
  }

  if (missing(adm_mon)) {
    adm_mon <- defaults$adm_mon
  }
  if (!is.null(adm_mon)) {
    insertFields <- c(insertFields, "adm_mon")
    insertValues <- c(insertValues, adm_mon)
  }
  ...
  if (!is.null(adm_date)) {
    insertFields <- c(insertFields, "adm_date")
    insertValues <- c(insertValues, adm_date)
  }
  ...
  if (!is.null(disc_mon)) {
    insertFields <- c(insertFields, "disc_mon")
    insertValues <- c(insertValues, disc_mon)
  }

  if (missing(disc_date)) {
    disc_date <- defaults$disc_date
  }
  if (!is.null(disc_date)) {
    insertFields <- c(insertFields, "disc_date")
    insertValues <- c(insertValues, disc_date)
  }
  ...
  if (!is.null(i_o_ind)) {
    insertFields <- c(insertFields, "i_o_ind")
    insertValues <- c(insertValues, i_o_ind)
  }
  ...
  if (!is.null(pat_type)) {
    insertFields <- c(insertFields, "pat_type")
    insertValues <- c(insertValues, pat_type)
  }
  ...
  if (!is.null(apr_sev)) {
    insertFields <- c(insertFields, "apr_sev")
    insertValues <- c(insertValues, apr_sev)
  }
  ...
  if (!is.null(apr_mort)) {
    insertFields <- c(insertFields, "apr_mort")
    insertValues <- c(insertValues, apr_mort)
  }
  ...
  if (!is.null(point_of_origin)) {
    insertFields <- c(insertFields, "point_of_origin")
    insertValues <- c(insertValues, point_of_origin)
  }
  ...
  if (!is.null(mart_status)) {
    insertFields <- c(insertFields, "mart_status")
    insertValues <- c(insertValues, mart_status)
  }
  ...
  if (!is.null(admphy_spec)) {
    insertFields <- c(insertFields, "admphy_spec")
    insertValues <- c(insertValues, admphy_spec)
  }
  ...
  if (!is.null(adm_phy)) {
    insertFields <- c(insertFields, "adm_phy")
    insertValues <- c(insertValues, adm_phy)
  }

  if (missing(attphy_spec)) {
    attphy_spec <- defaults$attphy_spec
  }
  if (!is.null(attphy_spec)) {
    insertFields <- c(insertFields, "attphy_spec")
    insertValues <- c(insertValues, attphy_spec)
  }
  ...
  if (!is.null(att_phy)) {
    insertFields <- c(insertFields, "att_phy")
    insertValues <- c(insertValues, att_phy)
  }

  if (missing(std_payor)) {
    std_payor <- defaults$std_payor
  }
  if (!is.null(std_payor)) {
    insertFields <- c(insertFields, "std_payor")
    insertValues <- c(insertValues, std_payor)
  }
  ...
  if (missing(proj_wgt)) {
    proj_wgt <- defaults$proj_wgt
  }
  if (!is.null(proj_wgt)) {
    insertFields <- c(insertFields, "proj_wgt")
    insertValues <- c(insertValues, proj_wgt)
  }

  if (missing(pat_charges)) {
    pat_charges <- defaults$pat_charges
  }
  if (!is.null(pat_charges)) {
    insertFields <- c(insertFields, "pat_charges")
    insertValues <- c(insertValues, pat_charges)
  }
  ...
  if (!is.null(pat_cost)) {
    insertFields <- c(insertFields, "pat_cost")
    insertValues <- c(insertValues, pat_cost)
  }

  if (missing(pat_fix_cost)) {
    pat_fix_cost <- defaults$pat_fix_cost
  }
  if (!is.null(pat_fix_cost)) {
    insertFields <- c(insertFields, "pat_fix_cost")
    insertValues <- c(insertValues, pat_fix_cost)
  }

  if (missing(pat_var_cost)) {
    pat_var_cost <- defaults$pat_var_cost
  }
  if (!is.null(pat_var_cost)) {
    insertFields <- c(insertFields, "pat_var_cost")
    insertValues <- c(insertValues, pat_var_cost)
  }

  if (missing(disc_mon_seq)) {
    disc_mon_seq <- defaults$disc_mon_seq
  }
  if (!is.null(disc_mon_seq)) {
    insertFields <- c(insertFields, "disc_mon_seq")
    insertValues <- c(insertValues, disc_mon_seq)
  }
  ...
  if (!is.null(period)) {
    insertFields <- c(insertFields, "period")
    insertValues <- c(insertValues, period)
  }

  if (missing(medrec_key)) {
    medrec_key <- defaults$medrec_key
  }
  if (!is.null(medrec_key)) {
    insertFields <- c(insertFields, "medrec_key")
    insertValues <- c(insertValues, medrec_key)
  }
  ...
  if (!is.null(hispanic_ind)) {
    insertFields <- c(insertFields, "hispanic_ind")
    insertValues <- c(insertValues, hispanic_ind)
  }

  statement <- paste0("INSERT INTO @source_schema.pat (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}

add_patbill <- function(pat_key, std_chg_code, hosp_chg_id, serv_day, std_qty, hosp_qty, bill_charges, bill_cost, bill_fix_cost, bill_var_cost, period) {
  defaults <- frameworkContext$defaultValues$patbill;
  insertFields <- c()
  insertValues <- c()
  if (missing(pat_key)) {
  ...
  if (missing(serv_day)) {
    serv_day <- defaults$serv_day
  }
  if (!is.null(serv_day)) {
    insertFields <- c(insertFields, "serv_day")
    insertValues <- c(insertValues, serv_day)
  }
  ...
  if (!is.null(std_qty)) {
    insertFields <- c(insertFields, "std_qty")
    insertValues <- c(insertValues, std_qty)
  }
  ...
  if (!is.null(hosp_qty)) {
    insertFields <- c(insertFields, "hosp_qty")
    insertValues <- c(insertValues, hosp_qty)
  }

  if (missing(bill_charges)) {
    bill_charges <- defaults$bill_charges
  }
  if (!is.null(bill_charges)) {
    insertFields <- c(insertFields, "bill_charges")
    insertValues <- c(insertValues, bill_charges)
  }

  if (missing(bill_cost)) {
    bill_cost <- defaults$bill_cost
  }
  if (!is.null(bill_cost)) {
    insertFields <- c(insertFields, "bill_cost")
    insertValues <- c(insertValues, bill_cost)
  }

  if (missing(bill_fix_cost)) {
    bill_fix_cost <- defaults$bill_fix_cost
  }
  if (!is.null(bill_fix_cost)) {
    insertFields <- c(insertFields, "bill_fix_cost")
    insertValues <- c(insertValues, bill_fix_cost)
  }

  if (missing(bill_var_cost)) {
    bill_var_cost <- defaults$bill_var_cost
  }
  if (!is.null(bill_var_cost)) {
    insertFields <- c(insertFields, "bill_var_cost")
    insertValues <- c(insertValues, bill_var_cost)
  }
  ...
  statement <- paste0("INSERT INTO @source_schema.patbill (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}

add_patcpt <- function(pat_key, cpt_code, period) {
  defaults <- frameworkContext$defaultValues$patcpt;
  insertFields <- c()
  insertValues <- c()
  if (missing(pat_key)) {
  ...
  statement <- paste0("INSERT INTO @source_schema.patcpt (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}

add_paticd_diag <- function(pat_key, icd_version, icd_source, icd_code, icd_pri_sec, icd_poa, period) {
  defaults <- frameworkContext$defaultValues$paticd_diag;
  insertFields <- c()
  insertValues <- c()
  if (missing(pat_key)) {
  ...
  if (missing(icd_source)) {
    icd_source <- defaults$icd_source
  }
  if (!is.null(icd_source)) {
    insertFields <- c(insertFields, "icd_source")
    insertValues <- c(insertValues, icd_source)
  }
  ...
  if (!is.null(icd_pri_sec)) {
    insertFields <- c(insertFields, "icd_pri_sec")
    insertValues <- c(insertValues, icd_pri_sec)
  }
  ...
  statement <- paste0("INSERT INTO @source_schema.paticd_diag (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}

add_paticd_proc <- function(pat_key, icd_version, icd_source, icd_code, icd_pri_sec, proc_day, proc_phy, procphy_spec, period) {
  defaults <- frameworkContext$defaultValues$paticd_proc;
  insertFields <- c()
  insertValues <- c()
  if (missing(pat_key)) {
  ...
  if (missing(proc_day)) {
    proc_day <- defaults$proc_day
  }
  if (!is.null(proc_day)) {
    insertFields <- c(insertFields, "proc_day")
    insertValues <- c(insertValues, proc_day)
  }
  ...
  if (!is.null(proc_phy)) {
    insertFields <- c(insertFields, "proc_phy")
    insertValues <- c(insertValues, proc_phy)
  }

  if (missing(procphy_spec)) {
    procphy_spec <- defaults$procphy_spec
  }
  if (!is.null(procphy_spec)) {
    insertFields <- c(insertFields, "procphy_spec")
    insertValues <- c(insertValues, procphy_spec)
  }
  ...
  statement <- paste0("INSERT INTO @source_schema.paticd_proc (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
add_pattype <- function(pat_type, pat_type_desc) {
  ...
  if (!is.null(pat_type_desc)) {
    insertFields <- c(insertFields, "pat_type_desc")
    insertValues <- c(insertValues, pat_type_desc)
  }

  statement <- paste0("INSERT INTO @source_schema.pattype (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
add_payor <- function(std_payor, std_payor_desc) {
  ...
  if (!is.null(std_payor_desc)) {
    insertFields <- c(insertFields, "std_payor_desc")
    insertValues <- c(insertValues, std_payor_desc)
  }

  statement <- paste0("INSERT INTO @source_schema.payor (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
add_physpec <- function(phy_spec, phy_spec_desc) {
  ...
  if (!is.null(phy_spec)) {
    insertFields <- c(insertFields, "phy_spec")
    insertValues <- c(insertValues, phy_spec)
  }

  if (missing(phy_spec_desc)) {
    phy_spec_desc <- defaults$phy_spec_desc
  }
  if (!is.null(phy_spec_desc)) {
    insertFields <- c(insertFields, "phy_spec_desc")
    insertValues <- c(insertValues, phy_spec_desc)
  }

  statement <- paste0("INSERT INTO @source_schema.physpec (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
add_poorigin <- function(point_of_origin, point_of_origin_desc) {
  ...
  if (!is.null(point_of_origin_desc)) {
    insertFields <- c(insertFields, "point_of_origin_desc")
    insertValues <- c(insertValues, point_of_origin_desc)
  }

  statement <- paste0("INSERT INTO @source_schema.poorigin (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
add_providers <- function(prov_id, urban_rural, teaching, beds_grp, prov_region, prov_division, cost_type) {
  ...
  if (!is.null(urban_rural)) {
    insertFields <- c(insertFields, "urban_rural")
    insertValues <- c(insertValues, urban_rural)
  }
  ...
  if (!is.null(teaching)) {
    insertFields <- c(insertFields, "teaching")
    insertValues <- c(insertValues, teaching)
  }
  ...
  if (!is.null(beds_grp)) {
    insertFields <- c(insertFields, "beds_grp")
    insertValues <- c(insertValues, beds_grp)
  }

  if (missing(prov_region)) {
    prov_region <- defaults$prov_region
  }
  if (!is.null(prov_region)) {
    insertFields <- c(insertFields, "prov_region")
    insertValues <- c(insertValues, prov_region)
  }

  if (missing(prov_division)) {
    prov_division <- defaults$prov_division
  }
  if (!is.null(prov_division)) {
    insertFields <- c(insertFields, "prov_division")
    insertValues <- c(insertValues, prov_division)
  }
  ...
  if (!is.null(cost_type)) {
    insertFields <- c(insertFields, "cost_type")
    insertValues <- c(insertValues, cost_type)
  }

  statement <- paste0("INSERT INTO @source_schema.providers (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}

add_readmit <- function(medrec_key, pat_key, i_o_ind, in_extract, disc_mon, disc_mon_seq, days_from_prior, calc_los, gender, race, pat_type, point_of_origin, disc_status, adm_type, ms_drg, age, icd_version, prim_icd_diag_code, prim_icd_proc_code, pat_cost, pat_charges) {
  defaults <- frameworkContext$defaultValues$readmit;
  insertFields <- c()
  insertValues <- c()
  if (missing(medrec_key)) {
  ...
  if (missing(in_extract)) {
    in_extract <- defaults$in_extract
  }
  if (!is.null(in_extract)) {
    insertFields <- c(insertFields, "in_extract")
    insertValues <- c(insertValues, in_extract)
  }
  ...
  if (missing(days_from_prior)) {
    days_from_prior <- defaults$days_from_prior
  }
  if (!is.null(days_from_prior)) {
    insertFields <- c(insertFields, "days_from_prior")
    insertValues <- c(insertValues, days_from_prior)
  }

  if (missing(calc_los)) {
    calc_los <- defaults$calc_los
  }
  if (!is.null(calc_los)) {
    insertFields <- c(insertFields, "calc_los")
    insertValues <- c(insertValues, calc_los)
  }
  ...
  if (missing(prim_icd_diag_code)) {
    prim_icd_diag_code <- defaults$prim_icd_diag_code
  }
  if (!is.null(prim_icd_diag_code)) {
    insertFields <- c(insertFields, "prim_icd_diag_code")
    insertValues <- c(insertValues, prim_icd_diag_code)
  }

  if (missing(prim_icd_proc_code)) {
    prim_icd_proc_code <- defaults$prim_icd_proc_code
  }
  if (!is.null(prim_icd_proc_code)) {
    insertFields <- c(insertFields, "prim_icd_proc_code")
    insertValues <- c(insertValues, prim_icd_proc_code)
  }
  ...
  statement <- paste0("INSERT INTO @source_schema.readmit (", paste(insertFields, collapse = ", "), ") VALUES ('", paste(insertValues, collapse = "', '"), "');")
  frameworkContext$insertSql = c(frameworkContext$insertSql, statement);
  invisible(statement);
}
...
expect_condition_occurrence <- function(condition_occurrence_id, person_id, condition_concept_id, condition_start_date, condition_end_date, condition_type_concept_id, stop_reason, provider_id, visit_occurrence_id, condition_status_concept_id, condition_source_value, condition_source_concept_id, condition_status_source_value) {
  ...
  if (!missing(condition_status_concept_id)) {
    if (is.null(condition_status_concept_id)) {
      ...
      whereClasues <- c(whereClasues, paste0("condition_status_concept_id = (", as.character(condition_status_concept_id), ")"))
    } else {
  ...
  if (!missing(condition_status_source_value)) {
    if (is.null(condition_status_source_value)) {
      ...
      whereClasues <- c(whereClasues, paste0("condition_status_source_value = (", as.character(condition_status_source_value), ")"))
    } else {
...
expect_cost <- function(cost_id, cost_event_id, cost_domain_id, cost_type_concept_id, currency_concept_id, total_charge, total_cost, total_paid, paid_by_payer, paid_by_patient, paid_patient_copay, paid_patient_coinsurance, paid_patient_deductible, paid_by_primary, paid_ingredient_cost, paid_dispensing_fee, payer_plan_period_id, amount_allowed, revenue_code_concept_id, revenue_code_source_value) {
  ...
  if (!missing(cost_id)) {
    if (is.null(cost_id)) {
      ...
      whereClasues <- c(whereClasues, paste0("cost_id = (", as.character(cost_id), ")"))
    } else {
  ...
  if (!missing(cost_event_id)) {
    if (is.null(cost_event_id)) {
      ...
      whereClasues <- c(whereClasues, paste0("cost_event_id = (", as.character(cost_event_id), ")"))
    } else {
  ...
  if (!missing(cost_domain_id)) {
    if (is.null(cost_domain_id)) {
      ...
      whereClasues <- c(whereClasues, paste0("cost_domain_id = (", as.character(cost_domain_id), ")"))
    } else {
  ...
  if (!missing(cost_type_concept_id)) {
    if (is.null(cost_type_concept_id)) {
      ...
      whereClasues <- c(whereClasues, paste0("cost_type_concept_id = (", as.character(cost_type_concept_id), ")"))
    } else {
  ...
  if (!missing(total_charge)) {
    if (is.null(total_charge)) {
      ...
      whereClasues <- c(whereClasues, paste0("total_charge = (", as.character(total_charge), ")"))
    } else {
  ...
  if (!missing(total_cost)) {
    if (is.null(total_cost)) {
      ...
      whereClasues <- c(whereClasues, paste0("total_cost = (", as.character(total_cost), ")"))
    } else {
  ...
  if (!missing(paid_by_patient)) {
    if (is.null(paid_by_patient)) {
      ...
      whereClasues <- c(whereClasues, paste0("paid_by_patient = (", as.character(paid_by_patient), ")"))
    } else {
  ...
  if (!missing(paid_patient_copay)) {
    if (is.null(paid_patient_copay)) {
      ...
      whereClasues <- c(whereClasues, paste0("paid_patient_copay = (", as.character(paid_patient_copay), ")"))
    } else {
  ...
  if (!missing(paid_patient_coinsurance)) {
    if (is.null(paid_patient_coinsurance)) {
      ...
      whereClasues <- c(whereClasues, paste0("paid_patient_coinsurance = (", as.character(paid_patient_coinsurance), ")"))
    } else {
  ...
  if (!missing(paid_patient_deductible)) {
    if (is.null(paid_patient_deductible)) {
      ...
      whereClasues <- c(whereClasues, paste0("paid_patient_deductible = (", as.character(paid_patient_deductible), ")"))
    } else {
  ...
  if (!missing(paid_by_primary)) {
    if (is.null(paid_by_primary)) {
      ...
      whereClasues <- c(whereClasues, paste0("paid_by_primary = (", as.character(paid_by_primary), ")"))
    } else {
  ...
  if (!missing(paid_ingredient_cost)) {
    if (is.null(paid_ingredient_cost)) {
      ...
      whereClasues <- c(whereClasues, paste0("paid_ingredient_cost = (", as.character(paid_ingredient_cost), ")"))
    } else {
  ...
  if (!missing(paid_dispensing_fee)) {
    if (is.null(paid_dispensing_fee)) {
      ...
      whereClasues <- c(whereClasues, paste0("paid_dispensing_fee = (", as.character(paid_dispensing_fee), ")"))
    } else {
  ...
  if (!missing(amount_allowed)) {
    if (is.null(amount_allowed)) {
      ...
      whereClasues <- c(whereClasues, paste0("amount_allowed = (", as.character(amount_allowed), ")"))
    } else {
...
lookup_cost <- function(fetchField, cost_id, cost_event_id, cost_domain_id, cost_type_concept_id, currency_concept_id, total_charge, total_cost, total_paid, paid_by_payer, paid_by_patient, paid_patient_copay, paid_patient_coinsurance, paid_patient_deductible, paid_by_primary, paid_ingredient_cost, paid_dispensing_fee, payer_plan_period_id, amount_allowed, revenue_code_concept_id, revenue_code_source_value) {
  ...
  if (!missing(cost_id)) {
    if (is.null(cost_id)) {
      ...
      whereClauses <- c(whereClauses, "cost_id = '", cost_id,"'")
    }
  }
  ...
  if (!missing(cost_event_id)) {
    if (is.null(cost_event_id)) {
      ...
      whereClauses <- c(whereClauses, "cost_event_id = '", cost_event_id,"'")
    }
  }
  ...
  if (!missing(cost_domain_id)) {
    if (is.null(cost_domain_id)) {
      ...
      whereClauses <- c(whereClauses, "cost_domain_id = '", cost_domain_id,"'")
    }
  }
  ...
  if (!missing(cost_type_concept_id)) {
    if (is.null(cost_type_concept_id)) {
      ...
      whereClauses <- c(whereClauses, "cost_type_concept_id = '", cost_type_concept_id,"'")
    }
  }
  ...
  if (!missing(total_charge)) {
    if (is.null(total_charge)) {
      ...
      whereClauses <- c(whereClauses, "total_charge = '", total_charge,"'")
    }
  }
  ...
  if (!missing(total_cost)) {
    if (is.null(total_cost)) {
      ...
      whereClauses <- c(whereClauses, "total_cost = '", total_cost,"'")
    }
  }
  ...
  if (!missing(paid_by_patient)) {
    if (is.null(paid_by_patient)) {
      ...
      whereClauses <- c(whereClauses, "paid_by_patient = '", paid_by_patient,"'")
    }
  }
  ...
  if (!missing(paid_patient_copay)) {
    if (is.null(paid_patient_copay)) {
      ...
      whereClauses <- c(whereClauses, "paid_patient_copay = '", paid_patient_copay,"'")
    }
  }
  ...
  if (!missing(paid_patient_coinsurance)) {
    if (is.null(paid_patient_coinsurance)) {
      ...
      whereClauses <- c(whereClauses, "paid_patient_coinsurance = '", paid_patient_coinsurance,"'")
    }
  }
  ...
  if (!missing(paid_patient_deductible)) {
    if (is.null(paid_patient_deductible)) {
      ...
      whereClauses <- c(whereClauses, "paid_patient_deductible = '", paid_patient_deductible,"'")
    }
  }
  ...
  if (!missing(paid_by_primary)) {
    if (is.null(paid_by_primary)) {
      ...
      whereClauses <- c(whereClauses, "paid_by_primary = '", paid_by_primary,"'")
    }
  }
  ...
  if (!missing(paid_ingredient_cost)) {
    if (is.null(paid_ingredient_cost)) {
      ...
      whereClauses <- c(whereClauses, "paid_ingredient_cost = '", paid_ingredient_cost,"'")
    }
  }
  ...
  if (!missing(paid_dispensing_fee)) {
    if (is.null(paid_dispensing_fee)) {
      ...
      whereClauses <- c(whereClauses, "paid_dispensing_fee = '", paid_dispensing_fee,"'")
    }
  }
  ...
  if (!missing(amount_allowed)) {
    if (is.null(amount_allowed)) {
      ...
      whereClauses <- c(whereClauses, "amount_allowed = '", amount_allowed,"'")
    }
  }
