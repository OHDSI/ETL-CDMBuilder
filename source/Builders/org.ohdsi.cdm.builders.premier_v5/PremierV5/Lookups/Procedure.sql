...
where 
(
SOURCE_VOCABULARY_ID IN ('JNJ_PMR_PROC_CHRG_CD', 'CPT4', 'HCPCS', 'ICD10CM', 'ICD10PCS', 'ICD9CM', 'ICD9Proc') AND TARGET_DOMAIN_ID ='Procedure' AND SOURCE_CONCEPT_CLASS_ID NOT IN ('CPT4 Modifier', 'ICD10PCS Hierarchy')
)
OR
(
SOURCE_VOCABULARY_ID IN ('JNJ_PMR_PROC_CHRG_CD') AND TARGET_CONCEPT_ID=0
)
