...
This retrospective claims analysis utilized data from the Truven Health MarketScan® Commercial Claims Database for the period of [starting date] to [ending date]. These data included health insurance claims across the continuum of care (e.g. inpatient, outpatient, and outpatient pharmacy) as well as enrollment data from large employers and health plans across the United States who provide private healthcare coverage millions of employees, their spouses, and dependents. This administrative claims database includes a variety of fee-for-service, preferred provider organizations, and capitated health plans.
',
