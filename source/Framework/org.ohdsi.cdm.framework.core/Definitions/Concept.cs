   ...
   public class Concept
   {
      ...
      public List<LookupValue> GetSourceConceptIdValues(Vocabulary vocabulary, Field field, IDataRecord reader)
      {
         ...
         return conceptKey == null
          ...
          : mapper.Map(vocabulary, field.Key, conceptKey, reader.GetDateTime(field.EventDate), field.CaseSensitive);
      }
      ...
      public int? GetTypeId(Field field, IDataRecord reader)
      {
         ...
         var typeIds = mapper.Map(null, field.Key, reader.GetString(field.Key), reader.GetDateTime(field.EventDate), field.CaseSensitive);
