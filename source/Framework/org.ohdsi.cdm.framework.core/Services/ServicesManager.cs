...
namespace org.ohdsi.cdm.framework.core.CommonVocabulary
{
   public class ServicesManager
   {
      ...
      {
         var channelFactory = GetChannelFactory("net.pipe://localhost/VocabularyServiceEndpoint");
      ...
      public static ChannelFactory<IVocabularyService> GetChannelFactory(string uri)
      {
         var binding = new NetNamedPipeBinding
         {
            MaxBufferPoolSize = 2147483647,
         ...
         var pipeFactory = new ChannelFactory<IVocabularyService>(binding, new EndpointAddress(uri));
