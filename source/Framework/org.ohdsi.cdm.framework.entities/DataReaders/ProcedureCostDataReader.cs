...
namespace org.ohdsi.cdm.framework.entities.DataReaders 
{
   ...
   {
      private readonly IEnumerator<ProcedureCost> enumerator;
      ...
      public object GetValue(int i)
      {
         ...
         switch (i)
         {
            ...
            case 1:
               return enumerator.Current.Id + offset.ProcedureOccurrenceOffset;
            ...
            case 9:
               return enumerator.Current.DiseaseClassConceptId;
            ...
            case 12:
               return enumerator.Current.DiseaseClassSourceValue;
