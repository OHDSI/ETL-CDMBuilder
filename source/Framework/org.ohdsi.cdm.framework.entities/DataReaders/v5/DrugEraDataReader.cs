...
namespace org.ohdsi.cdm.framework.entities.DataReaders.v5 
{
   public class DrugEraDataReader : IDataReader
   {
      ...
      public DrugEraDataReader(List<EraEntity> batch, KeyMasterOffset offset)
      {
         //this.batch = batch;
      ...
      public object GetValue(int i)
      {
         ...
         {
            case 0:
               return exposureEnumerator.Current.Id + offset.DrugEraOffset;
            case 1:
            ...
            case 6:
               return exposureEnumerator.Current.GapDays;
