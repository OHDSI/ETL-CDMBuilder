...
namespace org.ohdsi.cdm.framework.entities.DataReaders.v5 
{
   ...
   {
      private readonly IEnumerator<VisitCost> enumerator;
      private readonly KeyMasterOffset offset;

      // A custom DataReader is implemented to prevent the need for the HashSet to be transformed to a DataTable for loading by SqlBulkCopy
      public VisitCostDataReader(List<VisitCost> batch, KeyMasterOffset offset)
      {
      ...
      public object GetValue(int i)
      {
         ...
         switch (i)
         {
            ...
            case 0:
               return enumerator.Current.VisitCostId + offset.VisitCostOffset;

            case 1:
               return enumerator.Current.Id + offset.VisitOccurrenceOffset;
