...
namespace org.ohdsi.cdm.framework.entities.DataReaders.v5 
{
   public class DeviceExposureDataReader52 : IDataReader
   {
      ...
      public DeviceExposureDataReader52(List<DeviceExposure> batch, KeyMasterOffset offset)
      {
      ...
      public object GetValue(int i)
      {
         switch (i)
         {
            ...
            case 4:
               return enumerator.Current.StartTime ?? enumerator.Current.StartDate.ToString("HH:mm:ss", CultureInfo.InvariantCulture);
            case 5:
               return enumerator.Current.EndDate;
            case 6:
               return enumerator.Current.EndTime;
            case 7:
