   ...
   public class ObservationPeriodDataReader52 : IDataReader
   {
      ...
      public object GetValue(int i)
      {
         ...
         switch (i)
         {
            ...
            case 3:
               return observationPeriodsEnumerator.Current.StartTime ?? observationPeriodsEnumerator.Current.StartDate.ToString("HH:mm:ss", CultureInfo.InvariantCulture);
            case 4: 
               return observationPeriodsEnumerator.Current.EndDate;
            case 5:
               return observationPeriodsEnumerator.Current.EndTime ?? observationPeriodsEnumerator.Current.EndDate.Value.ToString("HH:mm:ss", CultureInfo.InvariantCulture);
            case 6:
