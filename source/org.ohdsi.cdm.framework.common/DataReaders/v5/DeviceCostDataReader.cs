...
namespace org.ohdsi.cdm.framework.common.DataReaders.v5
{
    public class DeviceCostDataReader : IDataReader
    {
        ...
        public DeviceCostDataReader(List<DeviceCost> batch, KeyMasterOffsetManager o)
        {
        ...
        public object GetValue(int i)
        {
            ...
            {
                case 0:
                    return _offset.GetId(_enumerator.Current.PersonId, _enumerator.Current.DeviceCostId);
                case 1:
