...
namespace org.ohdsi.cdm.framework.common.DataReaders.v5
{
    public class ProcedureCostDataReader : IDataReader
    {
        ...
        public ProcedureCostDataReader(List<ProcedureCost> batch, KeyMasterOffsetManager o)
        {
        ...
        public object GetValue(int i)
        {
            ...
            switch (i)
            {
                ...
                case 0:
                    return _offset.GetId(_enumerator.Current.PersonId, _enumerator.Current.ProcedureCostId);
