...
WHERE lower(SOURCE_VOCABULARY_ID) IN ('jnj_optum_dpos')
...
from Standard
union
select distinct '0' + SOURCE_CODE, TARGET_CONCEPT_ID, TARGET_DOMAIN_ID, SOURCE_VALID_START_DATE, SOURCE_VALID_END_DATE
from Standard