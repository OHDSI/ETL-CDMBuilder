		with cte_clinical_consultation as
		(
		select c.patid, c.adid, c.eventdate, con.constype, c.consid, c.staffid
		from {sc}.clinical c
		join {ch_sc}._chunks ch
		on ch.ChunkId = {0} AND c.patid = cast(ch.person_source_value as int8)
		left join {sc}.consultation con
		on c.patid = con.patid and c.consid = con.consid
		)
		...
		JOIN {ch_sc}._chunks ch ON ch.ChunkId = {0} AND a.patid = cast(ch.person_source_value as int8)
		join {sc}.entity e on a.enttype = e.code
		left join cte_clinical_consultation c on c.patid = a.patid and c.adid = a.adid
		...
		group by ch.PartitionId, ch.person_id, c.eventdate, c.constype, c.consid, c.staffid, e.category, a.enttype, e.description, e.data_fields, e.data1,
		...
		join {sc}.entity e
		on a.enttype = e.code
		left join cte_clinical_consultation c
		...
		group by ch.PartitionId, ch.person_id, c.eventdate, c.constype, c.consid, c.staffid, e.category, a.enttype, e.description, e.data_fields, e.data2,
		...
		group by ch.PartitionId, ch.person_id, c.eventdate, c.constype, c.consid, c.staffid, e.category, a.enttype, e.description, e.data_fields, e.data3,
		...
		group by ch.PartitionId, ch.person_id, c.eventdate, c.constype, c.consid, c.staffid, e.category, a.enttype, e.description, e.data_fields, e.data4,
		...
		group by ch.PartitionId, ch.person_id, c.eventdate, c.constype, c.consid, c.staffid, e.category, a.enttype, e.description, e.data_fields, e.data5,
		...
		group by ch.PartitionId, ch.person_id, c.eventdate, c.constype, c.consid, c.staffid, e.category, a.enttype, e.description, e.data_fields, e.data6,
		...
		group by ch.PartitionId, ch.person_id, c.eventdate, c.constype, c.consid, c.staffid, e.category, a.enttype, e.description, e.data_fields, e.data7,
		...
		group by ch.PartitionId, ch.person_id, c.eventdate, c.constype, c.consid, c.staffid, e.category, a.enttype, e.description, e.data_fields, sm.scoring_method,
		...
		(cast(EXTRACT(DAY from a.eventdate) as bigint) * 100) + coalesce(a.constype, 99) as visit_occurrence_id,
		...
		data,
		concat(concat(concat(concat(concat(concat(cast(enttype as varchar(5)), '-'), category), '-'), description), '-') , data)  as source_value
		from cte_a a
